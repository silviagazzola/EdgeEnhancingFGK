function w = SNrightPrec_tv2D(xx, invW_2d, u, v, Q, pinvDiag, sizeP, tflag)
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    w = SNrightPrec_grad2D(y, u, v, Q, pinvDiag, sizeP, tflag);
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    y = SNrightPrec_grad2D(xx, u, v, Q, pinvDiag, sizeP, tflag);
